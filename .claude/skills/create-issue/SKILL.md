---
name: create-issue
description: Draft a GitHub Issue as the spec artifact for this project's Spec-Driven Development workflow, before implementing a feature or fixing a bug.
---
